...
<body>
  	<a id="back" href="Home.jsp" class="btn btn-primary">Back</a>
	<div class="row">
		<div class="col-md-6">
			<div id="bigimage">
		...
		<div class="col-md-6">
			...
			<div>
				<a href="Buynonuser.jsp" class="btn btn-primary" id="buy">Buy</a>
				<form action="addtokart" method="post">
				<a href="#" type="submit" onclick="fun()" class="btn btn-warning" id="addkart">Add to Kart</a>
				</form>
			</div>
		</div>
	</div>
